      ...
      <div className='p-40 md:p-48 bg-gray-100 w-full '>
        ...
        <div className='flex flex-col gap-4 md:gap-8 justify-center items-center w-full'>
            ...
            <div className='flex flex-col gap-4 justify-center items-center w-full'>
                ...
                <button className='border border-gray-400 focus:outline-none p-3 w-[300px] md:w-[540px] bg-white font-bold flex items-center justify-center gap-4'><FcGoogle size={22}/>Login with Google</button>
                <button className='border border-gray-400 focus:outline-none p-3 w-[300px] md:w-[540px] bg-white font-bold flex items-center justify-center gap-4'><FaGithub size={22} />Sign in with Github</button>
